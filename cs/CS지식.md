...
**타겟이 되는 (가장 점유율이 높은) 브라우저부터 맞추는 것**이 좋다.
...
![img](CS%EC%A7%80%EC%8B%9D.assets/img.png)DevOps를 위한 웹 UI 테스트 환경 구성 예 - 출처 : CURVE 
...
![img](CS%EC%A7%80%EC%8B%9D.assets/img.png)![img](CS%EC%A7%80%EC%8B%9D.assets/img.png)
...
![img](CS%EC%A7%80%EC%8B%9D.assets/img.png)Render Tree 구조도 - 출처 : http://bit.ly/2Okn0fG
...
![img](CS%EC%A7%80%EC%8B%9D.assets/img.png)Viewport 에 상대적인 요소 연산 - 출처 : http://bit.ly/3137pmh
